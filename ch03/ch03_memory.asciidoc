...
* vermenigvuldig je het aantal cachelijnen (aantal sets x lijnen per set) dan resulteert dat in 73728 bits. De hoeveelheid geheugen die nodig is om dit geheugen te maken is dus 73728 (grootte overhead) + 64kB (grootte cache). dit komt op 598016 bits.
